...
export function Footer() {
	return (
		<footer className="md:rounded-t-6xl relative w-full max-w-6xl mx-auto flex flex-col items-center justify-center rounded-t-4xl border-t border-white/20 bg-[radial-gradient(35%_128px_at_50%_0%,rgb(255_255_255/8%),transparent)] px-6 py-12 lg:py-16 bg-black">
