			...
			<div className="mx-auto w-full max-w-6xl space-y-5 px-4">
				...
				>
					<div className="flex justify-center">
						<div className="rounded-lg border border-white/20 bg-white/5 backdrop-blur-sm px-4 py-1 font-mono text-white/90">Pricing</div>
					</div>
				...
				<div className="relative">
					<div
						className={cn(
							...
							'bg-[linear-gradient(to_right,rgb(255_255_255/.2)_1px,transparent_1px),linear-gradient(to_bottom,rgb(255_255_255/.2)_1px,transparent_1px)]',
							'bg-[size:32px_32px]',
					...
					>	
						<div className="grid md:grid-cols-2 bg-black relative border border-white/20 p-4">
								...
								<div className="space-y-1">
									<div className="flex items-center justify-between">
										...
										<div className="flex items-center gap-x-1">
											<span className="text-white/70 text-sm line-through">$8.99</span>
											<Badge variant="secondary">11% off</Badge>
										</div>
									</div>
									<p className="text-white/70 text-sm">Best value for growing businesses!</p>
								</div>
							...
							<div className="relative w-full rounded-lg border border-white/20 bg-white/5 px-4 pt-5 pb-4">
								<BorderTrail
									style={{
										boxShadow:
								...
								<div className="space-y-1">
									...
									<p className="text-white/70 text-sm">Unlock savings with an annual commitment!</p>
								</div>
								<div className="mt-10 space-y-4">
